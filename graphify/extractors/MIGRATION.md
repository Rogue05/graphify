...
| json_config | yes |
| c_cpp (c, cpp) | yes |
| (config-driven core: python, js, java, csharp, kotlin, scala, php, lua, swift, groovy, vue, svelte, astro, xaml, groovy) | no — shared _extract_generic core, move as one batch |
